...
//   return payload;
// };
// ChatBotApi.js - API للشات بوت الطبي
...
// // دالة مساعدة للتأكد من أن القيمة array
// const ensureArray = (data) => {
//   if (!data) return [];
//   if (Array.isArray(data)) return data;
//   if (typeof data === 'string') {
//     // تحويل string لـ array (مفصولة بفاصلة)
//     return data.split(',').map(s => s.trim()).filter(Boolean);
//   }
//   return [];
// };

// // دالة مساعدة للتأكد من أن القيمة number أو null
...
// ChatBotApi.js - API الشات بوت الطبي
