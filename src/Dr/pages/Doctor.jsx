...
import scan from "../../assets/img/WhatsApp Image 2026-02-07 at 16.07.11.jpeg";
import lab from "../../assets/img/WhatsApp Image 2026-02-07 at 18.47.30.jpeg";
              ...
              <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-red-50 p-4 rounded-xl">
                      ...
                      <ul className="text-sm space-y-1">
                        {(currentPatient.chronicDiseases || currentPatient.chronic_diseases || []).map((disease, i) => (
                          <li key={i} className="text-slate-700">• {disease}</li>
                        ))}
                      </ul>
                    </div>
                    <div className="bg-orange-50 p-4 rounded-xl">
                      ...
                      <ul className="text-sm space-y-1">
                        {(currentPatient.allergies || []).map((allergy, i) => (
                          <li key={i} className="text-slate-700">• {allergy}</li>
                        ))}
                      </ul>
                    </div>
                    <div className="bg-green-50 p-4 rounded-xl">
                      ...
                      <ul className="text-sm space-y-1">
                        {(currentPatient.medications || []).map((med, i) => (
                          <li key={i} className="text-slate-700">• {med}</li>
                        ))}
                      </ul>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-6">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-xl border border-blue-500">
                    ...
                    <p className='py-3'>
                      {currentPatient.symptoms || currentPatient.aiAnalysis?.symptoms || 'No symptoms reported'}
                    </p>
                    <div className="bg-white p-4 rounded-lg grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <div className="font-bold text-slate-800">
                          {currentPatient.aiDiagnosis || currentPatient.ai_diagnosis || 
                           currentPatient.aiAnalysis?.diagnosis || 'N/A'}
                        </div>
                      </div>
                      <div>
                        <div className="text-2xs text-slate-600 mb-1">Confidence Level</div>
                        <div className="font-bold text-slate-800">
                          {currentPatient.aiConfidence || currentPatient.ai_confidence || 
                           currentPatient.aiAnalysis?.confidence || 'N/A'}%
                        </div>
                      </div>
                      <div>
                        <div className="text-2xs text-slate-600 mb-1">Recommended Department</div>
                        <div className="font-bold text-slate-800">
                          {currentPatient.recommendedDept || currentPatient.recommended_dept || 
                           currentPatient.aiAnalysis?.department || 'N/A'}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <div className="sm:h-48 h-39 bg-slate-900 flex items-center justify-center overflow-hidden">
                        <img 
                          src={uploadedXray || currentPatient.xray || scan} 
                          alt="X-ray" 
                    ...
                    >
                      <div className="sm:h-48 h-39 bg-slate-900 flex items-center justify-center overflow-hidden">
                        <img 
                          src={uploadedLab || currentPatient.labTest || currentPatient.lab_test || lab} 
                          alt="Lab Test" 
                          className="h-full w-full object-cover" 
                        />
                      </div>
